...
public class FrontOfficeApi {
     ...
     */
    public okhttp3.Call getSimilarDocumentsCall(String documentId, Integer count, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getSimilarDocumentsValidateBeforeCall(String documentId, Integer count, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'documentId' is set
        if (documentId == null) {
            throw new ApiException("Missing the required parameter 'documentId' when calling getSimilarDocuments(Async)");
        }

        return getSimilarDocumentsCall(documentId, count, _callback);
     ...
     */
    public SemanticSearchResponse getSimilarDocuments(String documentId, Integer count) throws ApiException {
        ApiResponse<SemanticSearchResponse> localVarResp = getSimilarDocumentsWithHttpInfo(documentId, count);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SemanticSearchResponse> getSimilarDocumentsWithHttpInfo(String documentId, Integer count) throws ApiException {
        okhttp3.Call localVarCall = getSimilarDocumentsValidateBeforeCall(documentId, count, null);
     ...
     */
    public okhttp3.Call getSimilarDocumentsAsync(String documentId, Integer count, final ApiCallback<SemanticSearchResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getSimilarDocumentsValidateBeforeCall(documentId, count, _callback);
        Type localVarReturnType = new TypeToken<SemanticSearchResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
